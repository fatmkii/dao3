<template>
    <n-flex :wrap="false" style="margin-top: 8px;">
        <!-- 题图 -->
        <img style="height: 2.5rem;cursor: pointer;" src="/ui/miku-loudspeaker.png"
...
function addKeyFrames() {
    ...
    const container = document.getElementsByClassName("loudspeaker-content")[0] as HTMLDivElement | undefined
