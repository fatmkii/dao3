import{w as V,$ as A,bi as mt,bj as xt,S as d,bk as we,bl as yt,bm as ee,bn as wt,Y as n,a_ as Q,Z as R,a1 as o,L as We,a7 as te,d as N,a8 as _e,C as Le,bo as Ct,I as St,J as Be,K as Rt,an as $t,ay as Tt,bp as zt,aw as Pt,bq as Wt,a0 as C,br as Ce,a9 as ie,a3 as _t,q as oe,e as Lt,V as Bt,a4 as k,bs as At,a5 as Et,al as j,au as J,aD as Se,aa as se,bt as kt,bd as Z,bu as jt,ah as le,ac as It,ad as Ot,bv as Ht,W as Dt}from"./app-Bnyjg8n9.js";import{A as Ft}from"./Add-fXet-zDs.js";const Mt=we(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[we("&::-webkit-scrollbar",{width:0,height:0})]),Nt=V({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=A(null);function r(l){!(l.currentTarget.offsetWidth<l.currentTarget.scrollWidth)||l.deltaY===0||(l.currentTarget.scrollLeft+=l.deltaY+l.deltaX,l.preventDefault())}const s=mt();return Mt.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:xt,ssr:s}),Object.assign({selfRef:e,handleWheel:r},{scrollTo(...l){var u;(u=e.value)===null||u===void 0||u.scrollTo(...l)}})},render(){return d("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});var Vt=/\s/;function Xt(e){for(var r=e.length;r--&&Vt.test(e.charAt(r)););return r}var Ut=/^\s+/;function Yt(e){return e&&e.slice(0,Xt(e)+1).replace(Ut,"")}var Re=NaN,qt=/^[-+]0x[0-9a-f]+$/i,Gt=/^0b[01]+$/i,Kt=/^0o[0-7]+$/i,Jt=parseInt;function $e(e){if(typeof e=="number")return e;if(yt(e))return Re;if(ee(e)){var r=typeof e.valueOf=="function"?e.valueOf():e;e=ee(r)?r+"":r}if(typeof e!="string")return e===0?e:+e;e=Yt(e);var s=Gt.test(e);return s||Kt.test(e)?Jt(e.slice(2),s?2:8):qt.test(e)?Re:+e}var de=function(){return wt.Date.now()},Zt="Expected a function",Qt=Math.max,ea=Math.min;function ta(e,r,s){var p,l,u,c,v,m,g=0,x=!1,_=!1,L=!0;if(typeof e!="function")throw new TypeError(Zt);r=$e(r)||0,ee(s)&&(x=!!s.leading,_="maxWait"in s,u=_?Qt($e(s.maxWait)||0,r):u,L="trailing"in s?!!s.trailing:L);function y(f){var $=p,D=l;return p=l=void 0,g=f,c=e.apply(D,$),c}function T(f){return g=f,v=setTimeout(W,r),x?y(f):c}function S(f){var $=f-m,D=f-g,X=r-$;return _?ea(X,u-D):X}function P(f){var $=f-m,D=f-g;return m===void 0||$>=r||$<0||_&&D>=u}function W(){var f=de();if(P(f))return z(f);v=setTimeout(W,S(f))}function z(f){return v=void 0,L&&p?y(f):(p=l=void 0,c)}function H(){v!==void 0&&clearTimeout(v),g=0,p=m=l=v=void 0}function B(){return v===void 0?c:z(de())}function h(){var f=de(),$=P(f);if(p=arguments,l=this,m=f,$){if(v===void 0)return T(m);if(_)return clearTimeout(v),v=setTimeout(W,r),y(m)}return v===void 0&&(v=setTimeout(W,r)),c}return h.cancel=H,h.flush=B,h}var aa="Expected a function";function ce(e,r,s){var p=!0,l=!0;if(typeof e!="function")throw new TypeError(aa);return ee(s)&&(p="leading"in s?!!s.leading:p,l="trailing"in s?!!s.trailing:l),ta(e,r,{leading:p,maxWait:r,trailing:l})}const ra=n("divider",`
 position: relative;
 display: flex;
 width: 100%;
