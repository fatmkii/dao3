import{w as Z,$ as A,bc as ut,bd as vt,S as b,be as me,bf as ht,bg as J,bh as gt,K as xt,L as $e,P as mt,d as Q,ap as yt,C as wt,aQ as St,bi as Ct,bj as Rt,bk as Tt,a0 as r,a3 as i,a2 as S,a1 as B,aM as zt,T as $t,a9 as Pe,bl as ye,ab as re,a5 as Pt,r as ne,e as Wt,V as Lt,a6 as k,bm as _t,a7 as At,an as j,bn as Y,aa as Bt,bo as we,ac as oe,bp as Et,b7 as q,bq as kt,aj as ie,ae as jt,af as It,br as Ot,W as Ht}from"./app-DNiDbruX.js";import{A as Ft}from"./Add-DttGtZWj.js";const Mt=me(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[me("&::-webkit-scrollbar",{width:0,height:0})]),Dt=Z({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=A(null);function n(l){!(l.currentTarget.offsetWidth<l.currentTarget.scrollWidth)||l.deltaY===0||(l.currentTarget.scrollLeft+=l.deltaY+l.deltaX,l.preventDefault())}const d=ut();return Mt.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:vt,ssr:d}),Object.assign({selfRef:e,handleWheel:n},{scrollTo(...l){var m;(m=e.value)===null||m===void 0||m.scrollTo(...l)}})},render(){return b("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});var Nt=/\s/;function Vt(e){for(var n=e.length;n--&&Nt.test(e.charAt(n)););return n}var Xt=/^\s+/;function Ut(e){return e&&e.slice(0,Vt(e)+1).replace(Xt,"")}var Se=NaN,Gt=/^[-+]0x[0-9a-f]+$/i,Kt=/^0b[01]+$/i,Yt=/^0o[0-7]+$/i,qt=parseInt;function Ce(e){if(typeof e=="number")return e;if(ht(e))return Se;if(J(e)){var n=typeof e.valueOf=="function"?e.valueOf():e;e=J(n)?n+"":n}if(typeof e!="string")return e===0?e:+e;e=Ut(e);var d=Kt.test(e);return d||Yt.test(e)?qt(e.slice(2),d?2:8):Gt.test(e)?Se:+e}var se=function(){return gt.Date.now()},Qt="Expected a function",Jt=Math.max,Zt=Math.min;function ea(e,n,d){var u,l,m,v,f,x,h=0,g=!1,W=!1,L=!0;if(typeof e!="function")throw new TypeError(Qt);n=Ce(n)||0,J(d)&&(g=!!d.leading,W="maxWait"in d,m=W?Jt(Ce(d.maxWait)||0,n):m,L="trailing"in d?!!d.trailing:L);function y(c){var R=u,F=l;return u=l=void 0,h=c,v=e.apply(F,R),v}function T(c){return h=c,f=setTimeout(P,n),g?y(c):v}function C(c){var R=c-x,F=c-h,N=n-R;return W?Zt(N,m-F):N}function $(c){var R=c-x,F=c-h;return x===void 0||R>=n||R<0||W&&F>=m}function P(){var c=se();if($(c))return z(c);f=setTimeout(P,C(c))}function z(c){return f=void 0,L&&u?y(c):(u=l=void 0,v)}function H(){f!==void 0&&clearTimeout(f),h=0,u=x=l=f=void 0}function _(){return f===void 0?v:z(se())}function p(){var c=se(),R=$(c);if(u=arguments,l=this,x=c,R){if(f===void 0)return T(x);if(W)return clearTimeout(f),f=setTimeout(P,n),y(x)}return f===void 0&&(f=setTimeout(P,n)),v}return p.cancel=H,p.flush=_,p}var ta="Expected a function";function le(e,n,d){var u=!0,l=!0;if(typeof e!="function")throw new TypeError(ta);return J(d)&&(u="leading"in d?!!d.leading:u,l="trailing"in d?!!d.trailing:l),ea(e,n,{leading:u,maxWait:n,trailing:l})}const ce=xt("n-tabs"),We={tab:[String,Number,Object,Function],name:{type:[String,Number],required:!0},disabled:Boolean,displayDirective:{type:String,default:"if"},closable:{type:Boolean,default:void 0},tabProps:Object,label:[String,Number,Object,Function]},sa=Z({__TAB_PANE__:!0,name:"TabPane",alias:["TabPanel"],props:We,setup(e){const n=$e(ce,null);return n||mt("tab-pane","`n-tab-pane` must be placed inside `n-tabs`."),{style:n.paneStyleRef,class:n.paneClassRef,mergedClsPrefix:n.mergedClsPrefixRef}},render(){return b("div",{class:[`${this.mergedClsPrefix}-tab-pane`,this.class],style:this.style},this.$slots)}}),aa=Object.assign({internalLeftPadded:Boolean,internalAddable:Boolean,internalCreatedByPane:Boolean},Tt(We,["displayDirective"])),be=Z({__TAB__:!0,inheritAttrs:!1,name:"Tab",props:aa,setup(e){const{mergedClsPrefixRef:n,valueRef:d,typeRef:u,closableRef:l,tabStyleRef:m,addTabStyleRef:v,tabClassRef:f,addTabClassRef:x,tabChangeIdRef:h,onBeforeLeaveRef:g,triggerRef:W,handleAdd:L,activateTab:y,handleClose:T}=$e(ce);return{trigger:W,mergedClosable:Q(()=>{if(e.internalAddable)return!1;const{closable:C}=e;return C===void 0?l.value:C}),style:m,addStyle:v,tabClass:f,addTabClass:x,clsPrefix:n,value:d,type:u,handleClose(C){C.stopPropagation(),!e.disabled&&T(e.name)},activateTab(){if(e.disabled)return;if(e.internalAddable){L();return}const{name:C}=e,$=++h.id;if(C!==d.value){const{value:P}=g;P?Promise.resolve(P(e.name,d.value)).then(z=>{z&&h.id===$&&y(C)}):y(C)}}}},render(){const{internalAddable:e,clsPrefix:n,name:d,disabled:u,label:l,tab:m,value:v,mergedClosable:f,trigger:x,$slots:{default:h}}=this,g=l??m;return b("div",{class:`${n}-tabs-tab-wrapper`},this.internalLeftPadded?b("div",{class:`${n}-tabs-tab-pad`}):null,b("div",Object.assign({key:d,"data-name":d,"data-disabled":u?!0:void 0},yt({class:[`${n}-tabs-tab`,v===d&&`${n}-tabs-tab--active`,u&&`${n}-tabs-tab--disabled`,f&&`${n}-tabs-tab--closable`,e&&`${n}-tabs-tab--addable`,e?this.addTabClass:this.tabClass],onClick:x==="click"?this.activateTab:void 0,onMouseenter:x==="hover"?this.activateTab:void 0,style:e?this.addStyle:this.style},this.internalCreatedByPane?this.tabProps||{}:this.$attrs)),b("span",{class:`${n}-tabs-tab__label`},e?b(wt,null,b("div",{class:`${n}-tabs-tab__height-placeholder`}," "),b(St,{clsPrefix:n},{default:()=>b(Ft,null)})):h?h():typeof g=="object"?g:Ct(g??d)),f&&this.type==="card"?b(Rt,{clsPrefix:n,class:`${n}-tabs-tab__close`,onClick:this.handleClose,disabled:u}):null))}}),ra=r("tabs",`
